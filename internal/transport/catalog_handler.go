...
func (h *CatalogHandler) CreateFocusType(c *gin.Context) {
	...
	if err != nil {
		RespondError(c, err, "Error al crear el tipo de enfoque.")
		return
	}
...
func (h *CatalogHandler) GetFocusTypes(c *gin.Context) {
	...
	if err != nil {
		RespondError(c, err, "Error al obtener los tipos de enfoque.")
		return
	}
...
func (h *CatalogHandler) CreateInterest(c *gin.Context) {
	...
	if err != nil {
		RespondError(c, err, "Error al crear el interés.")
		return
	}
...
func (h *CatalogHandler) GetInterests(c *gin.Context) {
	...
	if err != nil {
		RespondError(c, err, "Error al obtener los intereses.")
		return
	}
